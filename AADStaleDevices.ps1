<#	
	...
	Lines 70 & 71: Fill out 'to' and 'from' field
	Line 79-81: Fill out your certificate information or use another method to connect to Graph. See https://bit.ly/3G6kpeV for more information
	===========================================================================
	.PARAMETER Threshold
...
elseif ($DisableDevices)
{
	...
	Send-MailMessage -From $From -To $To -Subject $ddSubject -SmtpServer $SMTPServer -Port $SMTPPort -Credential $ECred -Attachments $Attachments -UseSsl
}
elseif ($RemoveDevices)
{
	...
	Send-MailMessage -From $From -To $To -Subject $rdSubject -SmtpServer $SMTPServer -Port $SMTPPort -Credential $ECred -Attachments $Attachments -UseSsl
}
